...
% #2 added short note about resting state limitations
...
The remainder of the paper is structured as follows. Section 2 reviews the theoretical background of analytical and modeling methods in biomedical signal processing. Section 3 describes the proposed neural network architecture for ECG and PPG analysis. Section 4 presents the experimental setup and datasets comprising cardiac recordings obtained with the Polar device and pulse wave measurements gathered via a mobile application. Section 5 discusses the results of the study, evaluating the performance and effectiveness of the proposed methods, while Section 6 concludes the work and outlines directions for future research.
...
% -> #7 KOREKTA Opis interfejsu #TODO @julian zerknij na to oraz na dodany przeze mnie opis tego jak działa algos z linjki ~313 
...
% Akwizycja danych została podzielona na etapy treningu i walidacji. Do trenowania modelu przeprowadzono niezależne sesje nagraniowe. Do walidacji wykorzystano funkcję aplikacji „Save Both”, rejestrującą zsynchronizowane sygnały EKG i PPG jednocześnie. Pozwoliło to na uzyskanie wyrównanych zbiorów danych umożliwiających precyzyjną ocenę wydajności próbka-po-próbce na danych, których model nie widział podczas treningu.
