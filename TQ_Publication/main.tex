...
\authors{
  \author
  {Jan Kosma Bancerewicz, Julian Kotłowski, Ostap Lozovyy, Julia Beata Morawska, Mateusz Rzęsa}% Author name and surname
...
\bibitem{1}
J. D. Bronzino and D. R. Peterson, Eds., \emph{The Biomedical Engineering Handbook}, 4th ed., vol. 3: Biomedical Signals, Imaging and Informatics. Boca Raton, FL, USA: CRC Press, 2015.
...
\bibitem{3}
L. Sörnmo and P. Laguna, \emph{Bioelectrical Signal Processing in Cardiac and Neurological Applications}. Amsterdam, The Netherlands: Elsevier Academic Press, 2005.

\bibitem{4}
P. Podder, M. M. Hasan, M. R. Islam, and M. Sayeed, “Design and Implementation of Butterworth, Chebyshev-I and Elliptic Filter for Speech Signal Analysis,” \emph{arXiv preprint arXiv:2002.03130}, 2020.

\bibitem{5}
M. R. Keshtkaran and Z. Yang, “A fast, robust algorithm for power line interference cancellation in neural recording,” \emph{Journal of Neural Engineering}, vol. 11, no. 2, 2014, Art. no. 026017, doi: 10.1088/1741-2560/11/2/026017.

\bibitem{6}
S. K. Mitra, \emph{Digital Signal Processing: A Computer-Based Approach}, 4th ed. New York, NY, USA: McGraw-Hill, 2011. 
%S. K. Mitra, “Digital Signal Processing: A Computer-Based Approach”

\bibitem{7}
Y. Yue, “An effective electrocardiogram segments denoising method based on EEMD, EMD, and wavelet packet,” \emph{IET Signal Processing}, 2023, doi: 10.1049/sil2.12232.
...
\bibitem{8}
S. Haykin, \emph{Adaptive Filter Theory}, 5th ed. Pearson, 2013.
...
\bibitem{10}
O. Faust, Y. Hagiwara, T. J. Hong, O. S. Lih, and U. R. Acharya, “Deep learning for healthcare applications based on physiological signals: A review,” \emph{Computer Methods and Programs in Biomedicine}, 2018, doi: 10.1016/j.cmpb.2018.04.005.
%O. Faust, U. R. Acharya, H. Adeli, A. Adeli, “Deep learning for healthcare applications based on physiological signals: A review”


\bibitem{11}
A. Boulif, B. Ananou, M. Ouladsine, and S. Delliaux, “A literature review: ECG-based models for arrhythmia detection using AI techniques,” \emph{Bioinformatics and Biology Insights}, vol. 17, 2023, doi: 10.1177/11779322221149600.
% Weryfikacja: PubMed (PMC) artykułu, DOI 10.1177/11779322221149600, pisownia tytułu i autorów zgodnie z wersją PMC/PMC9926384. [turn0search0, turn0search4]
%A. Boulif et al., “A literature review: ECG-based models for arrhythmia detection using AI techniques”, 2023

\bibitem{12}
Z. Ebrahimi, “A review on deep learning methods for ECG arrhythmia classification,” \emph{Expert Systems with Applications: X}, vol. 7, 2020, Art. no. 100033, doi: 10.1016/j.eswax.2020.100033.
% Uwaga: nie znalazłem jednoznacznego artykułu z pełnymi danymi (tom, numer, DOI). Może to być preprint lub część zbioru przeglądów. Weryfikacja: przeszukaj IEEE Xplore, Google Scholar, Semantic Scholar używając tytułu + “Ebrahimi ECG arrhythmia review”.
%Z. Ebrahimi, “A review on deep learning methods for ECG arrhythmia detection”

\bibitem{13}
D. A. Coast, R. M. Stern, G. G. Cano, and S. A. Briller, “An approach to cardiac arrhythmia analysis using hidden Markov models,” \emph{IEEE Transactions on Biomedical Engineering}, 1990 Sep;37(9):826-36. doi: 10.1109/10.58593. PMID: 2227969.
% Uwaga: znalazłem artykuł “Hidden Markov Model Approach to Cardiac Arrhythmia Analysis” z doi: 10.1109/TBME.2002.806663 — to może być ta pozycja. Weryfikacja: sprawdź ten DOI lub nazwisko w IEEE Xplore.
%D. A. Coast, R. M. Stern, G. G. Cano, S. A. Briller, “An approach to cardiac arrhythmia analysis using hidden Markov models”

\bibitem{14}
K. Kazemi, “Robust PPG peak detection using dilated convolutional neural networks,” \emph{Sensors}, vol. 22, no. 16, 2022, doi: 10.3390/s22166054.
% Weryfikacja: MDPI / Sensors strona artykułu, numer tomu 22, numer wydania 16, DOI 10.3390/s22166054. [turn0search3]
%K. Kazemi, “Robust PPG Peak Detection Using Dilated Convolutional Neural Networks”

\bibitem{15}
S. Ikram, A. A. Baig, F. Khan, et al., “Transformer-based ECG classification for early detection of cardiac arrhythmias,” \emph{Frontiers in Medicine}, 2025, doi: 10.3389/fmed.2025.1600855.
% Weryfikacja: artykuł dostępny w Frontiers in Medicine z podanym DOI, rok 2025. [turn0search7]
